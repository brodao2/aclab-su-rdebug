...
import { SU_RDEBUG, SuLaunchConfiguration } from "./config";
import { DebugProtocol } from "@vscode/debugprotocol";

export function registerInspectorView(emitter: vscode.EventEmitter<any>) {
    ...
    disposables.push(
        ...
        vscode.commands.registerCommand("rdbg.inspector.startDebugSession", async (session: vscode.DebugSession) => {
            ...
            traceInspectorEnabled = await validVersion(config, treeProvider);
        }),
